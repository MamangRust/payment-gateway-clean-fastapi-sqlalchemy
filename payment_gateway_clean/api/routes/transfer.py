...
async def get_transfers(transfer_service: ITransferService = Depends(get_transfer_service)):
...
async def get_transfer(id: int, transfer_service: ITransferService = Depends(get_transfer_service)):
...
async def get_transfer_user(
    user_id: int, transfer_service: ITransferService = Depends(get_transfer_service)
):
...
async def create_transfer(
    input: CreateTransferRequest, transfer_service: ITransferService = Depends(get_transfer_service)
):
...
async def delete_transfer(id: int, transfer_service: ITransferService = Depends(get_transfer_service)):
