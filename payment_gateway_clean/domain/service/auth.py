...
class IAuthService(abc.ABC):
    @staticmethod
    async def register_user(self, session: Any,request: RegisterRequest) -> Union[ApiResponse[UserResponse], ErrorResponse]: ...

    @staticmethod
    async def login_user(self, session: Any,request: LoginRequest) -> Union[ApiResponse[str], ErrorResponse]: ...
